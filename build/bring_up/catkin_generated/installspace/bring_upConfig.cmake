...
if("FALSE" STREQUAL "TRUE")
  set(bring_up_SOURCE_PREFIX /home/s1/catkin_ws/src/RoboCupap2018RVRL_Demo-master/src/bring_up)
  set(bring_up_DEVEL_PREFIX /home/s1/catkin_ws/src/RoboCupap2018RVRL_Demo-master/devel)
  set(bring_up_INSTALL_PREFIX "")
  set(bring_up_PREFIX ${bring_up_DEVEL_PREFIX})
else()
  set(bring_up_SOURCE_PREFIX "")
  set(bring_up_DEVEL_PREFIX "")
  set(bring_up_INSTALL_PREFIX /home/s1/catkin_ws/src/RoboCupap2018RVRL_Demo-master/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Sara Tohidi <tohidi.sara.d@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bring_up' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/s1/catkin_ws/src/RoboCupap2018RVRL_Demo-master/install/${idir}'.  ${_report}")
    endif()
