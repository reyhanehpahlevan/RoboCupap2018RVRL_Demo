...
if("FALSE" STREQUAL "TRUE")
  set(bring_up_SOURCE_PREFIX /home/s2/Desktop/RoboCupap2018RVRL_Demo/src/bring_up)
  set(bring_up_DEVEL_PREFIX /home/s2/Desktop/RoboCupap2018RVRL_Demo/devel)
  set(bring_up_INSTALL_PREFIX "")
  set(bring_up_PREFIX ${bring_up_DEVEL_PREFIX})
else()
  set(bring_up_SOURCE_PREFIX "")
  set(bring_up_DEVEL_PREFIX "")
  set(bring_up_INSTALL_PREFIX /home/s2/Desktop/RoboCupap2018RVRL_Demo/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bring_up' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/s2/Desktop/RoboCupap2018RVRL_Demo/install/${idir}'.  ${_report}")
    endif()
